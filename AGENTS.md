...
This is a 3D game written in JavaScript on top of Three.js (rendering) and LittleJS (loop, input). Follow these strict architectural, syntax, and operational constraints when modifying or adding code.
